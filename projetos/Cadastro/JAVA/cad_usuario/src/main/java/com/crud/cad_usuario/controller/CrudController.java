...
import com.crud.cad_usuario.model.venda.DadosAlteracaoVenda;
import com.crud.cad_usuario.model.venda.DadosCadastroVenda;
import com.crud.cad_usuario.model.venda.Venda;
import com.crud.cad_usuario.model.venda.VendaRepository;
...
public class CrudController {
    ...
    @PostMapping("/enviaNomeFunc")
    @Transactional
    public void mudaVariavel(@RequestBody String selectedValue){
    ...
    public String paginaVendas(Model model,  Long idVenda){ // pega o id pelo link
        ...
        this.listaModelFunc(model,"funcionarios");
