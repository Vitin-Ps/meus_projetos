    ...
    public Set<Usuario> listar() { // aqui o uso so set em vez do list serve
        ...
        try {
            ...
            while (resultSet.next()) { // enquanto tiver informação no resultset
                ...
                DadosAberturaLogin dadosUsuario = new DadosAberturaLogin(login, senha); //criando um novo objeto record e recebendo os parametros pegos do mysql
    ...
    public Usuario listarPorLogin(String loginSelecionado) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                DadosAberturaLogin dadosUsuario = new DadosAberturaLogin(login, senha);
